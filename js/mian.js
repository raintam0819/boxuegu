define([], function () {
    ...
    require.config({
        ...
        paths: {
            ...
            courseCategoryAdd: 'js/course/course_category_add', courseCategory: 'js/course/course_category',
            ...
            userprofile: 'js/user/teacher_profile',
            userList: 'js/user/teacher_list',

            //配置第三方js模块别名
            template: 'lib/artTemplate/template-debug',
            bootstrap: 'lib/bootstrap/js/bootstrap',
            detapicker: 'lib/bootstrap-datepicker/js/bootstrap-datepicker',
